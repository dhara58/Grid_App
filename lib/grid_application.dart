                    ...
                    Column(
                      children: [
                        Padding(
                          ...
                          child: Icon(Icons.calendar_month,size: 55,),
                        ),
                      ],
                    ),
                    Center(
              ...
              Container(
                child: Center(child: Column(
                  children: [
                    Padding(
                      padding: const EdgeInsets.fromLTRB(25, 25, 25, 25),
                      child: Icon(Icons.festival,size: 55,),
                    ),
                    Center(
                      child: Center(
                        child: Padding(
                          padding: const EdgeInsets.only(),
                          child: Text('Festival',style: TextStyle(fontSize: 30),),
                        ),
                      ),
                    ),
                  ],
                  ...
                  children: [
                    ...
                    Center(
                      child: Center(
                        child: Padding(
                          padding: const EdgeInsets.only(),
                          child: Text('Food',style: TextStyle(fontSize: 30),),
                        ),
                      ),
                    ),
                  ],
                    ...
                    Center(
                      child: Center(
                        child: Padding(
                          ...
                          child: Text('Location',style: TextStyle(fontSize: 30),),
                        ),
                      ),
                    ),
                  ],
              ...
              Container(
                child: Center(child: Column(
                  children: [
                    Padding(
                      padding: const EdgeInsets.fromLTRB(25, 25, 25, 25),
                      child: Icon(Icons.today_outlined,size: 50,),
                    ),
                    Center(
                      child: Center(
                        child: Padding(
